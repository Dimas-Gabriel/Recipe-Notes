...
function initForm() {
    ...
    const editIndexStr = localStorage.getItem("editIndexDrink");
    const editIndex = editIndexStr !== null ? parseInt(editIndexStr) : null;
    ...
    form.onsubmit = e => {
        ...
        if (editIndex !== null) {
            ...
            localStorage.removeItem("editIndexDrink");  // FIXED
        } 
        // Tambah mode
        else {
            recipes.push(data);
